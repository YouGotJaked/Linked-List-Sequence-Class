...
//
// CONSTRUCTOR, COPY CONSTRUCTOR, and DESTRUCTOR for the sequence class:
//   sequence( )
//     Postcondition: The sequence has been initialized as an empty sequence.
//
//   sequence(const sequence& source)
//     Precondition: The current sequence is not the same object as source.
//     Postcondition: The current sequence is now equal to the source sequence.
//
//   ~sequence()
//     Postcondition: All nodes of the sequence have been returned to the heap,
//     the head pointer is now NULL, and many_nodes is reset to zero.
//
